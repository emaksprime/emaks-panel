...
const currentSerialStateLabels: Record<string, string> = {
...
export default function TechnicalServiceQrLinks() {
    ...
    const resolveContext = async () => {
        ...
        try {
            ...
            setStatus({
                type: 'error',
                message: error instanceof Error ? error.message : 'Seri bağlamı çözülemedi. Bu seri için ürün adı bulunamadı.',
            });
        }
    };
                ...
                {context && (
                    <div className="grid gap-3 rounded-xl border border-blue-100 bg-blue-50 p-4">
                        ...
                        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                            ...
                            <ReadOnlyField label="Stok kodu" value={context.stock_code} />
                            <ReadOnlyField label="Aktivasyon kodu" value={context.activation_code} />
                            <ReadOnlyField label="Güncel seri durumu" value={currentSerialStateLabels[context.current_serial_state ?? 'unknown'] ?? context.current_serial_state} />
