...
const moduleCards = [
    {
        ...
        description:
            'Satış kapsamları, müşteri ve ürün performansını takip edin.',
    ...
    },
    {
        title: 'Stok Yönetimi',
        description:
            'Pozitif stokları, kritik modelleri ve ürün görünürlüğünü yönetin.',
    ...
    },
    {
        ...
        description:
            'Alınan ve verilen açık siparişleri operasyonel sırada izleyin.',
    ...
    },
    {
        title: 'Teknik Servis',
        description:
            'Servis talepleri, teknisyenler ve operasyon dashboarduna geçin.',
        candidates: [
            '/technical-service',
    ...
    },
    {
        ...
        description:
            'Cari bilgi, bakiye ve ekstre ekranlarına hızlı erişim sağlayın.',
        ...
        <>
            ...
            <main className="min-h-[calc(100vh-9rem)] bg-[#f3f7fb] px-4 py-5 md:px-6 md:py-8">
                <section className="relative overflow-hidden rounded-3xl border border-blue-100 bg-white shadow-sm">
                    ...
                    <div className="absolute top-8 right-10 hidden h-28 w-28 rounded-full bg-blue-200/30 blur-2xl lg:block" />
                    ...
                    <div className="relative p-6 md:p-8 xl:p-10">
                        <div className="min-w-0">
                            <div className="inline-flex flex-col items-center gap-2 rounded-2xl border border-blue-100 bg-white/85 px-4 py-3 shadow-sm">
                                ...
                                />
                                <span className="text-xs font-bold tracking-[0.18em] whitespace-nowrap text-blue-700">
                                    Operasyon Paneli
                                </span>
                            </div>
                            <h1 className="mt-5 max-w-4xl [font-family:var(--font-display)] text-3xl font-semibold tracking-tight text-slate-950 md:text-5xl">
                                Hoş geldiniz
                                {auth?.user?.name ? `, ${auth.user.name}` : ''}
                            </h1>
                            <p className="mt-4 max-w-3xl text-base leading-7 text-slate-600">
                                Operasyon ekranlarına buradan hızlıca
                                ulaşabilirsiniz.
                            </p>
                            <a
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <span
                                        className={`grid size-12 shrink-0 place-items-center rounded-2xl bg-gradient-to-br ${card.tone} text-white shadow-sm`}
                                    >
                ...
                {visibleCards.length === 0 && (
                    <section className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-5 text-sm font-semibold text-amber-800">
                        Yetkili modül bulunamadı. Kullanıcı Yönetimi üzerinden
                        erişim tanımı yapılmalıdır.
                    </section>
                )}
            </main>
        </>
