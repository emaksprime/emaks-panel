...
const moduleItems = [
    ...
    { label: 'Teknik Servis', href: '/technical-service', match: ['/technical-service', '/technical-service/dashboard', '/technical-service/technicians', '/technical-service/serial-query'] },
