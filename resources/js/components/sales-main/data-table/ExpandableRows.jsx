            ...
            <tr className="border-b border-slate-100 transition hover:bg-slate-50">
                <td className="min-w-[260px] px-4 py-3">
                    <div className="flex items-center gap-2" style={{ paddingLeft: depth * 18 }}>
                        ...
                        <span className="max-w-[220px] truncate font-medium text-slate-900 sm:max-w-[520px]" title={row.label}>{row.label}</span>
                    </div>
                </td>
                <td className="whitespace-nowrap px-4 py-3 text-right text-slate-600">{row.quantityLabel}</td>
                <td className="whitespace-nowrap px-4 py-3 text-right font-semibold text-slate-950">{row.amountLabel}</td>
            </tr>
