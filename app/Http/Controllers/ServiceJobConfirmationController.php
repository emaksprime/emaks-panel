...
class ServiceJobConfirmationController extends Controller
{
    ...
    private function html(TechnicalServiceCustomerConfirmation $confirmation, string $state): string
    {
        ...
        return '<!doctype html><html lang="tr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'
            .e($title).
            '</title><style>body{margin:0;font-family:system-ui,-apple-system,Segoe UI,sans-serif;background:#f3f7fb;color:#0f172a}.wrap{max-width:680px;margin:40px auto;padding:24px}.card{background:white;border:1px solid #dbe4ef;border-radius:24px;padding:24px;box-shadow:0 24px 70px rgba(15,23,42,.08)}h1{font-size:28px;margin:0 0 12px}.muted{color:#64748b}.grid{display:grid;gap:12px;margin:20px 0}.row{border:1px solid #e2e8f0;border-radius:16px;padding:12px;background:#f8fafc}.notice{border:1px solid #bfdbfe;background:#eff6ff;color:#1e3a8a;border-radius:16px;padding:14px;font-weight:650}.actions{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:16px}.actions form{margin:0}label{display:grid;gap:8px;font-weight:600}textarea{border:1px solid #cbd5e1;border-radius:12px;padding:10px;font:inherit;min-width:0}button{width:100%;border:0;border-radius:14px;background:#06143a;color:white;font-weight:700;padding:13px 16px;cursor:pointer}.danger-button{background:#be123c}.success{border:1px solid #a7f3d0;background:#ecfdf5;color:#047857;border-radius:16px;padding:14px;font-weight:700}.danger{border:1px solid #fecdd3;background:#fff1f2;color:#be123c;border-radius:16px;padding:14px;font-weight:700}.legal{margin-top:16px;color:#64748b;font-size:12px}dialog{width:min(92vw,440px);border:0;border-radius:24px;padding:20px;box-shadow:0 24px 70px rgba(15,23,42,.22)}dialog::backdrop{background:rgba(15,23,42,.45)}.dialog-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:0 0 14px}.dialog-head button{width:40px;height:40px;padding:0;border-radius:999px;background:#f1f5f9;color:#0f172a}@media(max-width:520px){.wrap{margin:0;padding:16px}.card{border-radius:20px;padding:18px}.actions{grid-template-columns:1fr}h1{font-size:24px}}</style></head><body><main class="wrap"><section class="card"><h1>'
            .e($title).
