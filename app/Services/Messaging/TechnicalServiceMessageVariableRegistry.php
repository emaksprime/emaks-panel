...
class TechnicalServiceMessageVariableRegistry
{
    ...
    public function definitions(): array
    {
        return [
            ...
            'company_payment_amount_formatted' => $this->definition('Şirket ödeme tutarı', 'Şirket tarafından ustaya ödenecek ek hakediş toplamı.', '600,00 TL', 'settlement'),
            'technician_paid_amount_formatted' => $this->definition('Ustaya ödenen', 'Ustaya gerçekten ödenmiş canonical tutar.', '0,00 TL', 'settlement'),
            'technician_remaining_amount_formatted' => $this->definition('Ustaya kalan', 'Ustaya ödenecek canonical kalan tutar.', '1.250,00 TL', 'settlement'),
            'customer_collection_amount_formatted' => $this->definition('Müşteri tahsilatı', 'Şirket tarafından müşteriden tahsil edilen canonical tutar.', '1.250,00 TL', 'settlement'),
            'customer_collection_source_label' => $this->definition('Müşteri tahsilat kaynağı', 'Müşteri tahsilatının canonical kaynak açıklaması.', 'EMAKS Prime tarafından alındı', 'settlement'),
            'technician_payment_model_label' => $this->definition('Usta ödeme modeli', 'Usta hakedişinin canonical ödeme modeli.', 'Şirket ödemesi', 'settlement'),
            'technician_payment_source_label' => $this->definition('Usta ödeme kaynağı', 'Ustaya ödemeyi yapacak canonical taraf.', 'EMAKS Prime', 'settlement'),
            'technician_payment_status_label' => $this->definition('Usta ödeme durumu', 'Ustaya ödemenin payable/paid ayrımını gösteren etiket.', 'Ödenecek', 'settlement'),
            ...
            'technician_earning_sms_summary' => $this->definition('SMS hakediş özeti', 'SMS segment güvenliği için canonical kısa ekonomik kırılım.', "İşçilik 900,00 TL\nYol 350,00 TL\nToplam 1.250,00 TL", 'settlement'),
