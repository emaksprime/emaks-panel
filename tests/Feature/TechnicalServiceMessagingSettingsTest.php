...
class TechnicalServiceMessagingSettingsTest extends TestCase
{
    ...
    public function test_mikro_api_non_secret_settings_and_credentials_are_staged_independently(): void
    {
        ...
        $password = 'PR88_MIKRO_PASSWORD_TEST_ONLY';
        ...
        $payload = $this->actingAs($this->admin())
            ...
            ->assertJsonPath('messaging_settings.mikro_api.operation_catalog.contract_blocked_count', 13)
    ...
    public function test_admin_settings_page_contains_messaging_settings_without_send_button(): void
    {
        ...
        $this->assertStringContainsString('Yönetim Paneli’nde yönetilir.', $source);
