...
class PanelPermissionVisibilityTest extends TestCase
{
    ...
    public function test_module_layout_uses_first_visible_route_for_module_buttons(): void
    {
        ...
        $this->assertStringContainsString('max-w-7xl', $moduleLayout);
        $this->assertStringNotContainsString('max-w-[1600px]', $moduleLayout);
        $this->assertStringContainsString('lg:grid-cols-[auto_minmax(0,1fr)_auto]', $moduleLayout);
        $this->assertStringContainsString('justify-self-start', $moduleLayout);
        $this->assertStringContainsString('w-max max-w-full', $moduleLayout);
        ...
        $this->assertStringContainsString('pointer-events-none', $moduleLayout);
        $this->assertStringContainsString('pr-10', $moduleLayout);
        $this->assertStringContainsString('LayoutDashboard', $appSidebar);
        $this->assertStringContainsString("state === 'collapsed'", $appSidebar);
        $this->assertStringContainsString('sr-only', $appSidebar);
        $this->assertStringNotContainsString('showAdminSidebarMeta', $appSidebar);
        $this->assertStringNotContainsString('panelNavigation.role?.isSuperAdmin', $appSidebar);
        $this->assertStringNotContainsString('panelNavigation.meta.environment', $appSidebar);
        $this->assertStringNotContainsString('dashboard.emaksprime.com.tr', $appSidebar);
