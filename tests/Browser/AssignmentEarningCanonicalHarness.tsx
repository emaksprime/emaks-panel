...
const rootSrvFinanceCorrectionRequest = (): ServiceRequest => {
  const request = companyPaymentRequest()
  const transparentPixel = 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=='
  const servicePartPayment = {
    id: 207,
    payment_id: 207,
    request_id: 9001,
    root_request_id: 9001,
    srv_request_id: 9002,
    srv_request_code: 'SRV-2608DD180009-001',
    part_request_id: 38,
    status: 'paid',
    status_label: 'Ödendi',
    status_bucket: 'paid',
    amount: 1500,
    amount_label: '1.500,00 TL',
    amount_formatted: '1.500,00 TL',
    is_collected: true,
    included_in_selected_scope_total: true,
    purpose: 'service_and_part_payment',
    purpose_label: 'Servis ve parça ödemesi',
    service_amount: 1000,
    service_amount_label: '1.000,00 TL',
    selected_scope_service_amount: 1000,
    selected_scope_total_amount: 1000,
    part_amount: 500,
    part_amount_label: '500,00 TL',
    part_information_amount: 500,
    part_information_amount_label: '500,00 TL',
    component_split_persisted: true,
    relation_type: 'part_request',
    relation_id: 38,
    relation_label: 'Parça Talebi #38',
    source_type: 'payment',
    source_reference: 'Ödeme #207',
  }
  const mountPayment = {
    id: 208,
    payment_id: 208,
    ...
    status_bucket: 'paid',
    amount: 3500,
    amount_label: '3.500,00 TL',
    amount_formatted: '3.500,00 TL',
    is_collected: true,
    included_in_selected_scope_total: true,
    purpose: 'mount_collection',
    purpose_label: 'Montaj ödemesi',
    mount_amount: 3500,
    selected_scope_mount_amount: 3500,
    selected_scope_total_amount: 3500,
    relation_type: 'mrn',
    relation_id: 9001,
    relation_label: 'MRN MRN-2608DD180009',
    source_type: 'payment',
    source_reference: 'Ödeme #208',
  }
  const currentCollection = {
    ...
    part_amount: 0,
    unclassified_amount: 0,
    service_total_amount: 1000,
    total_amount: 1000,
    mount_amount_label: '0,00 TL',
    service_amount_label: '1.000,00 TL',
    extra_amount_label: '0,00 TL',
    route_amount_label: '0,00 TL',
    part_amount_label: '0,00 TL',
    unclassified_amount_label: '0,00 TL',
    service_total_amount_label: '1.000,00 TL',
    total_amount_label: '1.000,00 TL',
    included_collection_sources: [{
      source_type: 'payment', source_reference: 'Ödeme #207', source_label: 'Ödeme #207', payment_id: 207,
      amount: 1000, amount_label: '1.000,00 TL', status: 'paid', status_label: 'Ödendi', purpose_label: 'Servis ve parça ödemesi',
    }],
    included_source_total: 1000,
    included_source_total_label: '1.000,00 TL',
    reconciliation_ok: true,
    has_collection: true,
  }
  const currentPayout = {
    ...
    route_source_label: 'OPS tarafından manuel belirlendi',
    total_amount: 1500,
    labor_amount_label: '1.000,00 TL',
    route_fee_amount_label: '500,00 TL',
    total_amount_label: '1.500,00 TL',
    technician_paid_amount: 0,
    technician_remaining_amount: 1500,
    technician_paid_amount_label: '0,00 TL',
    technician_remaining_amount_label: '1.500,00 TL',
    payout_status: 'confirmed',
    payout_status_label: 'Onaylanan usta hakedişi',
    technician_id: 111,
    technician_name: 'Test Usta',
  ...
  const rootCollection = {
    ...
    part_amount: 500,
    unclassified_amount: 0,
    service_total_amount: 4500,
    total_amount: 5000,
    mount_amount_label: '3.500,00 TL',
    service_amount_label: '1.000,00 TL',
    extra_amount_label: '0,00 TL',
    route_amount_label: '0,00 TL',
    part_amount_label: '500,00 TL',
    unclassified_amount_label: '0,00 TL',
    service_total_amount_label: '4.500,00 TL',
    total_amount_label: '5.000,00 TL',
    included_collection_sources: [
      { source_type: 'payment', source_reference: 'Ödeme #208', source_label: 'Ödeme #208', payment_id: 208, amount: 3500, amount_label: '3.500,00 TL', status: 'paid', status_label: 'Ödendi', purpose_label: 'Montaj ödemesi' },
      { source_type: 'payment', source_reference: 'Ödeme #207', source_label: 'Ödeme #207', payment_id: 207, amount: 1500, amount_label: '1.500,00 TL', status: 'paid', status_label: 'Ödendi', purpose_label: 'Servis ve parça ödemesi' },
    ],
  ...
  const rootPayout = {
    ...
    total_amount: 5000,
    labor_amount_label: '4.000,00 TL',
    route_fee_amount_label: '1.000,00 TL',
    total_amount_label: '5.000,00 TL',
    technician_paid_amount: 0,
  ...
  const paidHistory = {
    paid_rows: [servicePartPayment], pending_rows: [], historical_groups: [],
    paid_count: 1, pending_count: 0, historical_count: 0, total_count: 1,
  }
  ...
  return {
    ...
    settlement: request.settlement ? {
      ...
      id: 91,
      technical_service_request_id: 9002,
      technical_service_assignment_offer_id: 121,
    ...
    partRequests: [{
      ...
      technical_service_request_id: 9001,
      root_request_id: 9001,
      service_visit_request_id: 9002,
      status: 'service_visit_created',
      status_label: 'Parça sonrası servis oluşturuldu',
      part_name: 'Sentetik parça',
      quantity: 1,
      requires_service_visit: true,
      charge_decision: 'chargeable',
      charge_decision_label: 'Ücretli',
      service_amount: 1000,
      service_amount_label: '1.000,00 TL',
      service_visit_route_fee_amount: 500,
      service_visit_route_fee_amount_label: '500,00 TL',
      service_visit_route_fee_source: 'ops_manual',
      service_visit_route_fee_source_label: 'OPS tarafından manuel belirlendi',
      part_amount: 500,
      part_amount_label: '500,00 TL',
      total_amount: 1500,
      total_amount_label: '1.500,00 TL',
    ...
    financeSummary: {
      ...
      scope: {
        ...
        root_request_id: 9001,
        current_srv_id: 9002,
        request_code: 'SRV-2608DD180009-001',
        root_mrn: 'MRN-2608DD180009',
        scope_type: 'current_srv',
      },
      scope_context: {
        current_record_type: 'srv',
        current_record_code: 'SRV-2608DD180009-001',
        root_request_id: 9001,
        root_mrn_code: 'MRN-2608DD180009',
        current_scope_key: 'current_srv',
        current_scope_label: 'Bu SRV',
        root_total_available: true,
        has_descendants: false,
        scope_options: [
          { key: 'current_srv', label: 'Bu SRV', available: true },
          { key: 'root_mrn_total', label: 'Kök MRN toplamı', available: true },
        ],
      },
      payment_records: {
        current_scope_rows: [servicePartPayment],
        related_scope_rows: [],
        root_scope_rows: [mountPayment, servicePartPayment],
        current_scope_history: paidHistory,
        root_scope_history: { ...paidHistory, paid_rows: [mountPayment, servicePartPayment], paid_count: 2, total_count: 2 },
      },
      current_visit: {
        ...request.financeSummary!.current_visit,
        is_service_visit: true,
        customer_collection: currentCollection,
        locksmith_payout: currentPayout,
        payout_status: 'confirmed',
        payout_status_label: 'Onaylanan usta hakedişi',
        net_margin: { amount: -500, amount_label: '-500,00 TL', provisional_amount_label: '-500,00 TL', is_definitive: true },
        result_state: 'definitive',
        result_state_label: 'Kesinleşmiş',
        is_definitive: true,
      },
    ...
    serviceVisitHistory: {
      ...
      reason: 'spare_part',
      reason_label: 'Parça sonrası servis',
      root_request: { id: 9001, mrn: 'MRN-2608DD180009', status: 'Tamamlandı', workflow_status: 'Tamamlandı' },
      current_request: { id: 9002, mrn: 'SRV-2608DD180009-001', root_mrn: 'MRN-2608DD180009', service_code: 'SRV-2608DD180009-001', is_current: true },
      history_records: [{
        id: 9002,
        mrn: 'SRV-2608DD180009-001',
        root_mrn: 'MRN-2608DD180009',
        service_code: 'SRV-2608DD180009-001',
        service_visit_reason_label: 'Parça sonrası servis',
        workflow_status: 'Usta Onayı Bekleyen',
        is_current: true,
        technician_name: 'Test Usta',
        root_door_photos: [{ id: 701, field_code: 'door_front_photo', label: 'Kapı ön yüzü', preview_url: transparentPixel, source_label: 'Kaynak: Kök MRN' }],
        previous_visit_documents: [{ id: 702, field_code: 'before_photo', label: 'Montaj öncesi', preview_url: transparentPixel, source_label: 'Kaynak: Önceki ziyaret' }],
        current_documents: [{ id: 703, field_code: 'after_photo', label: 'Montaj sonrası', preview_url: transparentPixel, source_label: 'Kaynak: Bu SRV' }],
        documents: [{ id: 703, field_code: 'after_photo', label: 'Montaj sonrası', preview_url: transparentPixel, source_label: 'Kaynak: Bu SRV' }],
        events: [],
      }],
    },
  }
...
const postPaidPartProjectionRequest = (): ServiceRequest => {
  ...
  const context: ServiceRequestPaymentOrderContext = {
    ...
    delivery_status_label: 'Bekliyor',
    shipment_record_exists: false,
    shipment_status: null,
    shipment_status_label: 'Kargo kaydı henüz oluşturulmadı',
    shipment_required: true,
    future_carrier_state: 'waiting_future_integration',
    future_carrier_label: 'Entegrasyon kapalı',
    shipping: {
...
function Harness() {
  ...
  return (
    <>
      <button
        type="button"
        data-testid="load-root-srv-finance-correction-scenario"
        onClick={() => {
          state.boardRefetchCount = 0
          state.scrollResetCount = 0
          setRequest(rootSrvFinanceCorrectionRequest())
        }}
      >Root / SRV finans düzeltme senaryosunu yükle</button>
      <button
        type="button"
        ...
        onExtraMountPaymentCreate={async (payload) => {
          ...
          try {
            ...
            const context: ServiceRequestPaymentOrderContext = {
              ...
              future_carrier_label: shipmentRequired ? 'Entegrasyon kapalı' : 'Sevkiyat yok',
