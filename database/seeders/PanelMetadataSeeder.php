...
class PanelMetadataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $resources = collect([
            ...
            ['code' => 'activation_code_search', 'name' => 'Aktivasyon Kodu Bul', 'type' => 'page'],
        ...
        $pages = collect([
            ...
            ['code' => 'activation_code_search', 'name' => 'Aktivasyon Kodu Bul', 'route' => '/activation-code-search', 'component' => 'panel/activation-code-search', 'layout_type' => 'module', 'icon' => 'key-round', 'description' => 'Seri numarası, kısa kod veya aktivasyon kodu ile ürün kaydı arama ekranı', 'resource_code' => 'activation_code_search', 'page_order' => 78, 'active' => true],
            ['code' => 'technical_service_technicians', 'name' => 'Teknisyen Yönetimi', 'route' => '/technical-service/technicians', 'component' => 'panel/technical-service-technicians', 'layout_type' => 'module', 'icon' => 'users', 'description' => 'Teknik servis usta ve çilingir kayıt yönetimi', 'resource_code' => 'technical_service_technicians', 'page_order' => 79, 'active' => true],
            ['code' => 'technical_service_earnings', 'name' => 'Servis Hakedişleri', 'route' => '/technical-service/earnings', 'component' => 'panel/technical-service-earnings', 'layout_type' => 'module', 'icon' => 'wallet-cards', 'description' => 'Servis ve çilingir aylık hakediş takip ekranı', 'resource_code' => 'technical_service_earnings', 'page_order' => 80, 'active' => true],
            ['code' => 'technical_service_admin', 'name' => 'Teknik Servis Admin', 'route' => '/technical-service/admin', 'component' => 'panel/technical-service-admin', 'layout_type' => 'module', 'icon' => 'settings', 'description' => 'Teknik servis modül ayarları ve yetki merkezi', 'resource_code' => 'technical_service_admin', 'page_order' => 81, 'active' => true],
        ...
        $menuItems = [
            ...
            ['menu_group' => 'technical_service', 'page' => 'activation_code_search', 'label' => 'Aktivasyon Kodu Bul', 'icon' => 'key-round', 'sort_order' => 78],
            ['menu_group' => 'technical_service', 'page' => 'technical_service_technicians', 'label' => 'Teknisyen Yönetimi', 'icon' => 'users', 'sort_order' => 79],
            ['menu_group' => 'technical_service', 'page' => 'technical_service_earnings', 'label' => 'Servis Hakedişleri', 'icon' => 'wallet-cards', 'sort_order' => 80],
            ['menu_group' => 'technical_service', 'page' => 'technical_service_admin', 'label' => 'Teknik Servis Admin', 'icon' => 'settings', 'sort_order' => 81],
...
SQL,
            ...
            [
                ...
                'filters_json' => [
                    ...
                    'managementScopes' => [
                        ...
                        ['key' => 'bulent_saglam', 'label' => 'Bülent Sağlam', 'repCode' => '0024', 'allowAll' => false, 'salesView' => 'temsilci', 'note' => 'Bülent Sağlam temsilci kapsamı', 'navigateTo' => null, 'resourceCode' => 'sales_rep_bulent_saglam'],
        ...
        PageConfig::query()->updateOrCreate(
            ...
            [
                'layout_json' => ['heroEyebrow' => 'Teknik Servis'],
                'filters_json' => [],
                'datasource_id' => null,
            ],
        );
