...
class PanelMetadataSeeder extends Seeder
{
    public function run(): void
    {
        $roles = collect([
            ...
            ['code' => 'technical', 'name' => 'Teknik', 'description' => 'Teknik servis, stok ve sipariş ekip erişimi', 'is_super_admin' => false],
        ...
        $resources = collect([
            ...
            ['code' => 'warehouse_terminal', 'name' => 'Depo Terminal', 'type' => 'page'],
            ...
            ['code' => 'technical_service', 'name' => 'Teknik Servis Talepleri', 'type' => 'page'],
            ...
            ['code' => 'technical_service_admin', 'name' => 'Teknik Servis Admin', 'type' => 'page'],
            ['code' => 'technical_service_serial_check', 'name' => 'Teknik Servis Seri No Montaj Kontrol Veri Kaynağı', 'type' => 'data_source'],
            ['code' => 'technical_service_serial_history', 'name' => 'Teknik Servis Seri No Hareket Geçmişi Veri Kaynağı', 'type' => 'data_source'],
            ['code' => 'technical_service_warranty_serial', 'name' => 'Teknik Servis Garanti Seri Sorgu Veri Kaynağı', 'type' => 'data_source'],
        ...
        $groups = collect([
            ...
            ['code' => 'operations', 'name' => 'Operasyon', 'icon' => 'boxes', 'menu_order' => 43, 'active' => true],
        ...
        $pages = collect([
            ...
            ['code' => 'warehouse_terminal', 'name' => 'Depo Terminal', 'route' => '/operations/warehouse-terminal', 'component' => 'panel/operations/warehouse-terminal', 'layout_type' => 'module', 'icon' => 'boxes', 'description' => 'Raf, seri, sipariş ve sevk işlemleri için kontrollü terminal ekranı.', 'resource_code' => 'warehouse_terminal', 'page_order' => 73, 'active' => true],
            ['code' => 'warehouse_terminal_rack_transfer', 'name' => 'Raf Transferi', 'route' => '/operations/warehouse-terminal/rack-transfer', 'component' => 'panel/operations/warehouse-terminal-rack-transfer', 'layout_type' => 'module', 'icon' => 'boxes', 'description' => 'Kaynak raf, ürün/seri ve hedef raf okutularak transfer hazırlığı yapılır.', 'resource_code' => 'warehouse_terminal', 'page_order' => 74, 'active' => true],
            ['code' => 'technical_service', 'name' => 'Teknik Servis', 'route' => '/technical-service', 'component' => 'panel/technical-service', 'layout_type' => 'module', 'icon' => 'wrench', 'description' => 'Montaj ve teknik servis talepleri takip ekranı', 'resource_code' => 'technical_service', 'page_order' => 75, 'active' => true],
            ['code' => 'technical_service_dashboard', 'name' => 'Operasyon Dashboard', 'route' => '/technical-service/dashboard', 'component' => 'panel/technical-service-dashboard', 'layout_type' => 'module', 'icon' => 'activity', 'description' => 'İç operasyon teknik servis takip ekranı', 'resource_code' => 'technical_service_dashboard', 'page_order' => 76, 'active' => true],
            ['code' => 'technical_service_serial_query', 'name' => 'Seri No Sorgu', 'route' => '/technical-service/serial-query', 'component' => 'panel/technical-service-serial-query', 'layout_type' => 'module', 'icon' => 'search', 'description' => 'Mikro seri no geçmişi ve garanti kontrol ekranı', 'resource_code' => 'technical_service_serial_query', 'page_order' => 77, 'active' => true],
            ['code' => 'technical_service_technicians', 'name' => 'Teknisyen Yönetimi', 'route' => '/technical-service/technicians', 'component' => 'panel/technical-service-technicians', 'layout_type' => 'module', 'icon' => 'users', 'description' => 'Teknik servis usta ve çilingir kayıt yönetimi', 'resource_code' => 'technical_service_technicians', 'page_order' => 78, 'active' => true],
            ['code' => 'technical_service_earnings', 'name' => 'Servis Hakedişleri', 'route' => '/technical-service/earnings', 'component' => 'panel/technical-service-earnings', 'layout_type' => 'module', 'icon' => 'wallet-cards', 'description' => 'Servis ve çilingir aylık hakediş takip ekranı', 'resource_code' => 'technical_service_earnings', 'page_order' => 79, 'active' => true],
            ['code' => 'technical_service_admin', 'name' => 'Teknik Servis Admin', 'route' => '/technical-service/admin', 'component' => 'panel/technical-service-admin', 'layout_type' => 'module', 'icon' => 'settings', 'description' => 'Teknik servis modül ayarları ve yetki merkezi', 'resource_code' => 'technical_service_admin', 'page_order' => 80, 'active' => true],
            ...
            ['code' => 'accounting_finance_resmi_stok_kontrol', 'name' => 'Resmi Stok Kontrolü', 'route' => '/accounting-finance/resmi-stok-kontrol', 'component' => 'panel/accounting-finance/resmi-stok-kontrol', 'layout_type' => 'module', 'icon' => 'calculator', 'description' => 'Resmi stok ve Mikro fiili stok farklarının kategori bazlı yönetim görünümü.', 'resource_code' => 'accounting_finance_resmi_stok_kontrol', 'page_order' => 95, 'active' => true],
        ...
        $menuItems = [
            ...
            ['menu_group' => 'operations', 'page' => 'warehouse_terminal', 'label' => 'Depo Terminal', 'icon' => 'boxes', 'sort_order' => 73],
            ['menu_group' => 'technical_service', 'page' => 'technical_service', 'label' => 'Teknik Servis', 'icon' => 'wrench', 'sort_order' => 75],
            ['menu_group' => 'technical_service', 'page' => 'technical_service_dashboard', 'label' => 'Operasyon Dashboard', 'icon' => 'activity', 'sort_order' => 76],
            ['menu_group' => 'technical_service', 'page' => 'technical_service_serial_query', 'label' => 'Seri No Sorgu', 'icon' => 'search', 'sort_order' => 77],
            ['menu_group' => 'technical_service', 'page' => 'technical_service_technicians', 'label' => 'Teknisyen Yönetimi', 'icon' => 'users', 'sort_order' => 78],
            ['menu_group' => 'technical_service', 'page' => 'technical_service_earnings', 'label' => 'Servis Hakedişleri', 'icon' => 'wallet-cards', 'sort_order' => 79],
            ['menu_group' => 'technical_service', 'page' => 'technical_service_admin', 'label' => 'Teknik Servis Admin', 'icon' => 'settings', 'sort_order' => 80],
                    ...
                    [
                        'can_view' => match ($role->code) {
                            ...
                            'technical' => in_array($resource->code, [
                                ...
                                'technical_service_serial_query',
